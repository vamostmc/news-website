...
namespace Web1.Migrations.TinTucDb
{
    ...
    [Migration("20241011193254_RemoveBL2")]
    partial class RemoveBL2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web1.Data.BinhLuan", b =>
                {
                    b.HasOne("Web1.Data.KhachHang", "KhachHang")
                        .WithMany("BinhLuans")
                        .HasForeignKey("KhachhangId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_BinhLuan_KhachHang_KhachhangId");
